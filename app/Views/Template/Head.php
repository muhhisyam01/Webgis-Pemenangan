...
<!-- DATATABLES -->
<link rel="stylesheet" href="<?= base_url('template/dist/assets/vendor/jquery-datatable/dataTables.bootstrap4.min.css')?>">
<link rel="stylesheet" href="<?= base_url('template/dist/assets/vendor/jquery-datatable/fixedeader/dataTables.fixedcolumns.bootstrap4.min.css')?>">
<link rel="stylesheet" href="<?= base_url('template/dist/assets/vendor/jquery-datatable/fixedeader/dataTables.fixedheader.bootstrap4.min.css')?>">
<script src="http://cdn.leafletjs.com/leaflet-0.7.3/leaflet.js"></script>
<link rel="stylesheet" href="<?= base_url('template/leaflet-locatecontrol/dist/L.Control.Locate.min.css'); ?>" />
  <script src="<?= base_url('template/leaflet-locatecontrol/src/L.Control.Locate.js'); ?>"></script>
    ...
    <nav class="navbar navbar-fixed-top">
        <div class="container-fluid">
            <div class="navbar-brand">
                ...
                <a href="index.html">Webgis-Pemenangan</a> 
            </div>
                ...
                <div class="tab-pane active" id="menu">
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu li_animation_delay">
                            <li class="active">
                                <a href="/" class="has-arrow"><i class="fa fa-dashboard"></i><span>Dashboard</span></a>
                                <!-- <ul>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a href="Relawan">Team</a></li>
                                    <li><a href="AnggotaRelawan">Anggota Team</a></li>
                                    <li><a href="coba">Maps</a></li>
