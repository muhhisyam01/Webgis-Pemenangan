<div id="main-content">
    ...
    <script>
        ...
        L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibXVoaGlzeWFtIiwiYSI6ImNsbGd4YmQxaTE3Nm0zZXFoOGNhbGFoeHQifQ.XbJsHa41Xb9yBluWg_V9qg', {
                maxZoom: 18,
